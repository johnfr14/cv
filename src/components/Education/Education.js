...
const Education = () => {
  return (
    <Box  as="section" id="Education" minWidth={600} m={0} p={0} style={{backgroundImage: `url(${bgHeader})`, backgroundSize: "cover", backgroundRepeat: 'no-repeat', backgroundAttachment: "fixed"}} height={['170vh', '170vh', "140h", "130vh"]}>
      <Center>
